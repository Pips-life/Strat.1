...
from .strategy_006_options_flow import Strategy006, Strategy006Config
...
registry._strategies[Strategy006.id] = Strategy006

__all__ = [
    "Signal", "Strategy", "registry",
    "Strategy001", "Strategy001Config",
    "Strategy002", "Strategy002Config",
    "Strategy003", "Strategy003Config",
    "Strategy004", "Strategy004Config",
    "Strategy005", "Strategy005Config",
    "Strategy006", "Strategy006Config",
]
